...
#
# Generated by export_simulation on Thu Apr 26 22:58:01 +0800 2018
#
################################################################################
...
switch to the './DMEM_block.sh' script.

./DMEM_block.sh -reset_run
...
./DMEM_block.sh -noclean_files

For more information on the script, please type './DMEM_block.sh -help'.
